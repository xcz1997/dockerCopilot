...
const sortOptions = [{ field: "name", label: "名称" }];
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div
                ...
                :class="[
                    'card card-hover p-4 cursor-pointer transition-all',
                    filterType === 'running' ? 'ring-2 ring-emerald-500' : '',
                ]"
            >
                <div class="flex items-center gap-3">
                    <div
            ...
            <div
                ...
                :class="[
                    'card card-hover p-4 cursor-pointer transition-all',
                    filterType === 'stopped' ? 'ring-2 ring-gray-500' : '',
                ]"
            >
                <div class="flex items-center gap-3">
            ...
            <div
                ...
                :class="[
                    'card card-hover p-4 cursor-pointer transition-all',
                    filterType === 'update' ? 'ring-2 ring-amber-500' : '',
                ]"
            >
                <div class="flex items-center gap-3">
                    <div
        ...
        <div v-else-if="error" class="card p-8 text-center">
            ...
            <button @click="fetchProjects" class="btn btn-primary mt-4">
                重试
            </button>
        </div>
            ...
            >
                ...
                >
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        >
                            <svg
                                v-if="updatingProjects.has(project.name)"
                        ...
                        >
                            <svg
                                :class="[
                                    ...
                                    isExpanded(project.name) && 'rotate-180',
                                ]"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <td class="py-3">
                                        <div class="text-xs">
                                            <span
                                                v-if="service.networkMode"
                                                class="text-gray-500 dark:text-gray-400"
                                            >
                                                {{ service.networkMode }}
                                            </span>
                                            <span
                                                v-if="service.networks?.length"
                                                class="text-gray-600 dark:text-gray-400 block"
                                            >
                                                {{
                                                    service.networks
                                                        .filter(
                                    ...
                                    <td class="py-3">
                                        <span
                                            class="text-gray-600 dark:text-gray-400 truncate max-w-[200px] block"
                                        >
                                            {{ service.image }}
                                        </span>
                                    </td>
